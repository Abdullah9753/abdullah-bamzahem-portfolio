      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div
          className={`grid gap-10 py-8 sm:grid-cols-12 md:py-12 ${
            border ? "border-t border-luxury-gold/20" : ""
          }`}
        >
          ...
          <div className="space-y-4 sm:col-span-12 lg:col-span-4">
            ...
            <div className="text-sm text-muted-gold leading-relaxed">
              ...
              {/* Luxury Headless Shopify Solutions.<br /> */}
          ...
          <div className="space-y-2 sm:col-span-6 md:col-span-3 lg:col-span-2">
            <h3 className="text-sm font-bold uppercase tracking-widest text-luxury-gold">Services</h3>
          ...
          {/* 3rd block: Showroom */}
          <div className="space-y-2 sm:col-span-6 md:col-span-3 lg:col-span-2">
            <h3 className="text-sm font-bold uppercase tracking-widest text-luxury-gold">Showroom</h3>
            <ul className="space-y-2 text-sm">
              <li>
                <Link className="text-muted-gold transition hover:text-white" href="https://commerce-eight-ebon-12.vercel.app/" target="_blank">
                  Lumina Store (Demo)
                </Link>
              </li>
              <li>
          ...
          {/* 4th block: Contact */}
          <div className="space-y-2 sm:col-span-6 md:col-span-3 lg:col-span-2">
            <h3 className="text-sm font-bold uppercase tracking-widest text-luxury-gold">Contact</h3>
            <ul className="space-y-2 text-sm">
              <li>
          ...
          {/* 5th block: Social */}
          <div className="space-y-2 sm:col-span-6 md:col-span-3 lg:col-span-2">
            <h3 className="text-sm font-bold uppercase tracking-widest text-luxury-gold">Social</h3>
