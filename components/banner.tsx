    ...
    <>
      {bannerOpen && (
        <div className="fixed bottom-0 right-0 z-50 w-full md:bottom-8 md:right-12 md:w-auto">
          <div className="flex justify-between bg-night-blue p-3 text-sm text-muted-gold shadow-lg md:rounded-sm border border-luxury-gold/20">
            <div className="inline-flex text-muted-gold">
              <a
            ...
            <button
              className="ml-3 border-l border-luxury-gold/30 pl-2 text-muted-gold hover:text-luxury-gold"
